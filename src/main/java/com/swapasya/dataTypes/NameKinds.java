...
public class NameKinds {
	...
	public static final String UnRegisteredPerson = "UnRegisteredPerson";
	public static final String roleWiseRules = "roleWiseRules";
	public static final String LibraryRules = "LibraryRules";
