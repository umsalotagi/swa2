							...
							<div class="">
								...
								<div class="">
									...
									<div class="x_panel">
										...
										<div class="x_content">
											<br />
											<form action="swa/book_related.jsp" id="demo-form2" data-parsley-validate
											...
											<div class="x_content">
												...
												<div class="accordion" id="accordion1" role="tablist"
													...
													<div class="panel" ng-controller="myctrl">
														...
														else if("BookID".equals(search))
														{
															BookTitleRepositoryMongoDB bktitlerepo=new BookTitleRepositoryMongoDB(DBConnect.getConnection());
															 bookTitles=bktitlerepo.findByBookId(txt);			
														}
																
														else if("Author".equals(search))
														{
															BookTitleRepositoryMongoDB bktitlerepo=new BookTitleRepositoryMongoDB(DBConnect.getConnection());
															bookTitles=bktitlerepo.findByAuthorRegex(txt);			
														}
																
														else if("Publication".equals(search))
														{
															BookTitleRepositoryMongoDB bktitlerepo=new BookTitleRepositoryMongoDB(DBConnect.getConnection());
										...
										<div class="x_panel" id="redirected1">
											<div class="x_title">
												...
												<div class="pull-right">
													<a class="btn btn-round btn-info" href="form_editbook1.html?bookTitleID='<%=bookTitle.getBookTitleID()%>'">
												...
												<div class="accordion" id="accordion" role="tablist"
													...
													<div class="panel ">
														...
														<div class="col-sm-9 invoice-col">
															<b>Book Title ID: </b>{{arr.bookTitleID}}  <br> 
															<!-- <b>Title: </b> {{arr.bookName}} <br> --> 
															<b>Author: </b> {{arr.author}} <br> 
															<b>Publication: </b> {{arr.publication}} <br>
															<!-- <b>Location: </b>{{arr.publication}} <br> -->
															<b>ISBN Number: </b> {{arr.isbnNumber}}<br>
															<b>Language: </b> {{arr.language}} <br>
															<b>Number Of Pages: </b> {{arr.noOfPages}} <br>
															<b>Tags: </b> <li ng-repeat="tag in arr.tags">
															{{tag}}
															</li> <br>
															<b>Binding Type: </b> {{arr.bindingType}} <br>
															<br>
														</div>
